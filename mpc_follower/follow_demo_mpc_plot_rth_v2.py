...
Q = np.diag([1000, 1000, 0.1, 1])  # state cost matrix
...
class Can_use:
    def __init__(self, zone):
        ...
        # 用于平滑航向角
        self.previous_yaw = -3.0  # 初始 yaw 转换为弧度
...
def main():
    # 使用示例
    trajectory_csv = '/home/nvidia/vcii/follow_trajectory/collect_trajectory/processed_shiyanzhongxin_0327_with_yaw_ck.csv'
    # 10
