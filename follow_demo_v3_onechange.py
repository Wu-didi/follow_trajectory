                    ...
                    with shared_data["lock"]:
                        if shared_data["frame"]['perception_result'] is not None:
                            ...
                            for one_obstacle in last_percepton_frame:
                                ...
                                if obstacle_x is not None and obstacle_y is not None and abs(obstacle_y) < 3 and abs(obstacle_x) < 15 and follower.closest_index !=0 :
...
def main():
    # 使用示例
    camera_index = 0
    trajectory_csv = '/home/nvidia/vcii/follow_trajectory/collect_trajectory/processed_haima-1111.csv'
    # 10
